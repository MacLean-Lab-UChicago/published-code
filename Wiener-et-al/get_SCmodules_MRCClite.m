function [ciu,Aall,anull,A] = get_SCmodules_MRCClite(K,sam1,sam2,maxC,r1,r2,tau)
...
% FIRST PASS - find gamma range where modules range from 2 to N;
% initial gamma range
...
for g=1:length(gam_range)
    [ci, ~] = community_louvain2(K,gam_range(g),[]);
    ciall(:,g) = ci;
end
